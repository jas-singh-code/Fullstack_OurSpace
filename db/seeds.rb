...
#   Character.create(name: 'Luke', movie: movies.first)
    ...
    users = User.create([
        {firstname: 'Angelique', lastname: 'Sugrim', username: 'asugrim99'},
        {firstname: 'Phunsuk', lastname: 'Wangroo', username: 'pwangroo12'},
        {firstname: 'Jaspreet', lastname: 'Singh', username: 'jsingh12'},
        {firstname: 'Loveleen', lastname: 'Kaur', username: 'lkaur96'},
        {firstname: 'Mintu', lastname: 'Sing', username: 'msingh21'}
    ])
